...
// Assuming FacebookIcon and InstagramIcon are defined elsewhere or similar to Footer's
  ...
  return (
    <section className="bg-gray-800 text-white section-padding">
      <div className="mx-auto max-w-7xl container-padding">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-white">Ready for ZazuQuickFix?</h2>
          <p className="mt-4 text-lg leading-8 text-gray-300 max-w-xl mx-auto">
            Get in touch today for a free quote or to book your next mobile auto service.
          </p>
        </motion.div>

        <motion.div 
          className="mt-16 grid grid-cols-1 gap-y-10 gap-x-8 md:grid-cols-3 lg:gap-x-12"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="text-center p-6 bg-gray-700/50 rounded-lg">
            ...
            <a href="tel:+13412386141" className="mt-1 text-lg text-gray-300 hover:text-accent transition-colors block">+1 (341) 238-6141</a>
          </div>
          <div className="text-center p-6 bg-gray-700/50 rounded-lg">
            <EnvelopeIcon className="h-10 w-10 text-primary mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-white">Email Us</h3>
            <a href="mailto:zazuquickfix@gmail.com" className="mt-1 text-lg text-gray-300 hover:text-accent transition-colors block">zazuquickfix@gmail.com</a>
          </div>
          <div className="text-center p-6 bg-gray-700/50 rounded-lg">
            {/* Placeholder for social icons in one block */}
            <div className="flex justify-center items-center h-10 mb-4 space-x-3">
            ...
            <p className="mt-1 text-lg text-gray-300">@ZazuQuickFix</p>
          </div>
        </motion.div>
